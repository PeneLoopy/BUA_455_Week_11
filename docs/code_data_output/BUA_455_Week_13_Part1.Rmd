...
- HW 5 - Part 2 is now posted and will be due Wednesday 12/6
...
bom_yr <- read_csv("bom_yearly_top_gross_2023_11_28.csv", show_col_types = F, skip=12) |>
...
**`1.`** In the previous chunk: 
   ...
   - Create an additional formatted date value, `day_updated_fmt` to indicate when data were updated. Data were updated on 11/28/2023, `today`.
